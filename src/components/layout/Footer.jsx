  ...
  return (
    <footer className="bg-[#14032B] relative text-white pt-20 pb-10 px-6 md:px-42 font-jakarta">
      ...
      <img
        ...
        alt="decoration"
      />
      <div className="max-w-7xl mx-auto grid grid-cols-2 lg:grid-cols-[1.3fr_1.1fr_1.1fr_1.3fr] gap-10 md:gap-14">
        {/* Column 1 */}
        ...
        <div className="md:mt-8">
          ...
          <div className="flex flex-col">
            <ul className=" text-[14px] md:text-[18px]  space-y-4  md:space-y-2 mt-6">
              {[
                {
                  name: "Blockchain",
                  link: "/blockchain",
